...
| `includes/seo-meta.php` | SEO meta tags & structured data component | (outputs HTML meta tags, JSON-LD) | **SEO COMPONENT** — Generates og:, twitter:, schema.org structured data; Fixes quote encoding; **ACTIVE — required by booking-confirmation.php:88** | None | ~200 lines |
...
|------|--------|----------|
| `includes/seo-meta.php` | **ACTIVE** | Required by booking-confirmation.php:88 via `require_once 'includes/seo-meta.php'` (builds confirmation page's <head> meta from $seo_data array, lines 81-89). Corrected 2026-07-14: Phase-0 grep missed the include. |
